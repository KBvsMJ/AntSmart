...
- (void)isEnableDelete {
    ...
    UILabel *deleteTitleLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, deleteImageView.frame.size.width, deleteImageView.frame.size.height)];
    [deleteTitleLabel setText:[Config DPLocalizedString:@"deletetitle"]];
    [deleteTitleLabel setTextAlignment:NSTextAlignmentCenter];
    [deleteTitleLabel setFont:[UIFont systemFontOfSize:14]];
    [deleteTitleLabel setTextColor:[UIColor whiteColor]];
    [deleteTitleLabel setBackgroundColor:[UIColor clearColor]];
    [deleteImageView addSubview:deleteTitleLabel];
}
