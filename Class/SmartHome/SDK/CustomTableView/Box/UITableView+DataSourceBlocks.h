...
typedef int (^UITableViewNumberOfSectionsInTableViewBlock)(UITableView* tableView);
...
typedef CGFloat (^UITableViewNumberOfRowsInSectionBlock)(UITableView* tableView, NSInteger section);
typedef int (^UITableViewSectionForSectionIndexTitleBlock)(UITableView* tableView, NSString* title, NSInteger index);
