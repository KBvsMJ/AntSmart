...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        //网络
        _networkLabel = [[UILabel alloc]initWithFrame:CGRectMake(SCREEN_CGSIZE_WIDTH-30, 5, 50, 25)];
        ...
        //分割线
        _imageLine = [[UIImageView alloc]initWithFrame:CGRectMake(60, 59, SCREEN_CGSIZE_WIDTH-60, 1)];
