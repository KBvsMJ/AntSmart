...
#import "IPHelpler.h"
#import "router.h"      /*the very same from google-code*/
#include <ifaddrs.h>
#include <arpa/inet.h>
#import <sys/sysctl.h>
#import <netinet/in.h>
...
+ (NSString *)getGatewayIPAddress {
    ...
    NSString *routerAccessAddress = [[NSString alloc]initWithFormat:@"http://%@",address];
    return routerAccessAddress;
}
